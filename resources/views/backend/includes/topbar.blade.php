        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              @else
              <img src="https://shikhbeshobai.com/public/frontend/assets/images/avater.png" class="wd-32 rounded-circle" alt="">
              @endif
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                <a href="">
                  @if(Auth::user()->image == !NULL)
                  <img src="{{ asset('backend/img/user/'. Auth::user()->image) }}" class="wd-80 rounded-circle" alt="">
                  @else
                  <img src="https://shikhbeshobai.com/public/frontend/assets/images/avater.png" class="wd-80 rounded-circle" alt="">
                  @endif
                </a>
