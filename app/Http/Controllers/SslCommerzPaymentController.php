...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data = array();
        $post_data['total_amount'] = $coursePrice; # You cant not pay less than 10
        ...
        $post_data['cus_course_id'] = $courseId;
    ...
    public function success(Request $request)
    {
        ...
        $order_detials = DB::table('orders')
            ...
            ->select('transaction_id', 'status', 'currency', 'amount', 'batch_id', 'user_id')->first();
        //get Batch info
        ...
        if ($order_detials->status == 'Pending') {
            ...
            if ($validation == TRUE) {
                ...
                */
                ...
                return view('frontend.pages.success', compact('order_detials', 'batch', 'user'));
            } else {
                /*
